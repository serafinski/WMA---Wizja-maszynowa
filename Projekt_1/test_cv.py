...
# Ew blur - na samym poczatku
# złożenia 2 warstwy (pilka + swiatlo) + Morfologia + marker
def upload(i):
    global files
    i = i - ord('0')
    image = norm_size(cv2.imread('/Users/tomek/Desktop/GIT/WMA---Wizja-maszynowa/Projekt_1/Assets/{}'.format(files[i])))
...
def main():
    ...
    files = os.listdir('/Users/tomek/Desktop/GIT/WMA---Wizja-maszynowa/Projekt_1/Assets/')
    num_image = ord('0')
    image = norm_size(cv2.imread('/Users/tomek/Desktop/GIT/WMA---Wizja-maszynowa/Projekt_1/Assets/{}'.format(files[0])))
    nimg = image.copy()
    cv2.imshow('obrazek', image)
